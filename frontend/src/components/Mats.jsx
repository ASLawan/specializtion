...
const Mats = () => {
  ...
  const matsProducts = products
    .filter((product) => product.category === "Mats")
    .slice(0, 5);
  ...
  return (
    <div className="client-products">
      ...
      <div className="client-product">
        {Array.isArray(matsProducts) && matsProducts.length > 0 ? (
          matsProducts.map((product) => (
          ...
          <div>
            <h3 className="noproducts">No Mats products available</h3>
          </div>
        )}
      </div>
    </div>
